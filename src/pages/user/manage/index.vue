        ...
        <el-form :inline="true" ref="formInline" :model="formInline" label-width="48px" >
          <el-form-item label="状态" size="mini">
            <el-select v-model="formInline.region" placeholder="请选择" style="width: 100px">
              ...
              <el-option label="代理注册" value="beijing"></el-option>
              <el-option label="人工代注" value="shanghai"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="会员" size="mini">
            <el-input v-model="formInline.user" placeholder="请输入"></el-input>
          </el-form-item>
          <el-form-item label="代理" size="mini">
            <el-input v-model="formInline.user" placeholder="请输入"></el-input>
          </el-form-item>

          <el-form-item size="mini">
            <el-button type="primary" @click="onSubmit" >查询</el-button>
            <el-button type="primary" @click="onSubmit" >批量设置特殊比例</el-button>
            <el-button type="primary" @click="onSubmit" >批量踢出房间</el-button>
          </el-form-item>
        </el-form>
      </div>
    </template>
